...
Public Class StringBuilderWriter
    ...
    Private _StrBuilder As System.Text.StringBuilder
    Public Sub New(ByVal strBuilder As System.Text.StringBuilder)
        _StrBuilder = strBuilder
    End Sub


    Public Sub Write(ByVal value As String) Implements IWriter.Write
        _StrBuilder.Append(value)
    End Sub

    Public Function GetContent() As String Implements IWriter.GetContent
        Return _StrBuilder.ToString()
    End Function

    Public Sub WriteLine() Implements IWriter.WriteLine
        _StrBuilder.Append(vbNewLine)
    End Sub
...
Public Class ObjectDumper
    Public Shared Sub Write(ByVal o As Object, ByVal writer As IWriter)
        Write(o, 0)
    End Sub
    ...
    Public Shared Sub Write(ByVal o As Object, ByVal depth As Integer, ByVal writer As IWriter)
        Dim dumper As New ObjectDumper(depth)
        dumper.writer = writer
        dumper.WriteObject(Nothing, o)
    End Sub

    Dim writer As IWriter 'TextWriter
